(() => {
  ...
  const placeInfo = {
    ...
    "Mehliskopf": p(
      "Mehliskopf הוא מתחם פעילות על דרך היער השחור הגבוהה, שבו אפשר לבלות יום שלם בלי לעבור בין אתרים: פארק חבלים בן שבעה מסלולים, מגלשת הרים, בנג׳י טרמפולינה, מתקני משחק ו-Downhill Carts בתנאים המתאימים.",
      "התחילו בפארק החבלים כשהאנרגיה גבוהה, עברו אחרי הצהריים למגלשת ההרים, והשאירו את הבנג׳י, מתקני המשחק והסיבובים הנוספים לשעות האחרונות.",
      "10:00–17:30, כולל כרטיס של שלוש שעות לפארק החבלים והפסקת צהריים.",
      "הפעילויות תלויות במזג האוויר ובצוות. ילדים מתחת לגיל 12 מטפסים עם מבוגר, עד שני ילדים לכל מבוגר; ה-Downhill Carts מיועדים מגיל 16 ומגובה 1.60 מ׳ ודורשים תיאום מראש.",
      "https://mehliskopf.de/en/"
    ),
    "Guémar": p(
