(() => {
  ...
  if (stayCard && !stayCard.querySelector(".offenburg-confirmation")) {
    ...
    panel.innerHTML = `
      ...
      <p class="offenburg-confirmation__private"><b>פרטי כניסה פרטיים:</b> קוד הדלת, סיסמת ה-Wi-Fi, מספר הטלפון של המארחים והוראות הכניסה המדויקות נשארים מחוץ לאתר הציבורי. כדאי לשמור את מייל האישור זמין בטלפון.</p>
    `;
